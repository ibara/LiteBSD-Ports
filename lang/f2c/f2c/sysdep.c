...
char link_msg[]	= "on Microsoft Windows system, link with libF77.lib;\n\
	on Linux or Unix systems, link with .../path/to/libF77.a -lm\n\
	or, if you install libF77.a in a standard place, with -lF77 -lm\n\
	-- in that order, at the end of the command line, as in\n\
		cc *.o -lF77 -lm\n\
	Source for libF77 is in /netlib/f2c/libF77.zip, e.g.,\n\n\
		http://www.netlib.org/f2c/libF77.zip";
