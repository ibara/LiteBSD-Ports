...
{
#if !defined(__UCLIBC__) && (defined(__FreeBSD__) || defined(linux) || defined(__OpenBSD__) || defined(__NetBSD__) || defined(LiteBSD) || defined(__APPLE__) || defined(__GNU__) || defined(__sun) || defined(sun))
...
#if defined(__APPLE__) || defined(__CYGWIN__) || defined(LiteBSD)
