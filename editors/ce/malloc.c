...
union mhead {
  ...
  struct {
    ...
    u_int16_t mi_magic2;	/* should be == MAGIC2 */	/* 2 */
...
#define MSLOP  4		/* 4 bytes extra for u_int32_t size */
     ...
     int line, flags;
{
  ...
  /* Since the sizeof(u_int32_t) bytes before the memory handed to the user
